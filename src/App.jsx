  ...
  return (
    <div dir="rtl" lang="ar" className="flex min-h-screen flex-col bg-white font-sans text-stone-900">
      ...
      <div className="sticky top-0 z-40">
        <header className="flex items-center justify-between border-b border-stone-200 bg-white px-4 py-2.5 shadow-sm">
          <button
            onClick={() => setSidebarOpen(true)}
            aria-label="فتح القائمة"
            className="flex h-9 w-9 items-center justify-center rounded-lg text-stone-500 hover:bg-stone-50"
          >
            <MenuIcon />
          </button>

          <p className="text-sm font-semibold tracking-wide text-amber-800">Mowafy</p>
      ...
      <main className="flex-1 pb-20">
        ...
        {view === "groups" && <Groups onDone={() => goTo("dashboard")} />}
